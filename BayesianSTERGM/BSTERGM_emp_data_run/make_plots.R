...
formation_posterior_sample = read.csv("C:/gitProject/BayesianSTERGM/BayesianSTERGM/BSTERGM_emp_data_run/seq1_chain4_BSTERGM_formation.csv", header=FALSE)
...
hist(formation_posterior_sample$V1)
hist(formation_posterior_sample$V2)


dissolution_posterior_sample = read.csv("C:/gitProject/BayesianSTERGM/BayesianSTERGM/BSTERGM_emp_data_run/seq1_chain4_BSTERGM_dissolution.csv", header=FALSE)
...
network_diag_stats = read.csv("C:/gitProject/BayesianSTERGM/BayesianSTERGM/BSTERGM_emp_data_run/seq1_chain4_BSTERGM_lastExNetSamplerNetworkStats.csv", header=TRUE)
