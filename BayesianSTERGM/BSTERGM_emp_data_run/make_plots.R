...
formation_posterior_sample = read.csv("C:/gitProject/BayesianSTERGM/BayesianSTERGM/BSTERGM_emp_data_run/seq3_chain3_BSTERGM_formation.csv", header=FALSE)
...
dissolution_posterior_sample = read.csv("C:/gitProject/BayesianSTERGM/BayesianSTERGM/BSTERGM_emp_data_run/seq3_chain3_BSTERGM_dissolution.csv", header=FALSE)
...
network_diag_stats = read.csv("C:/gitProject/BayesianSTERGM/BayesianSTERGM/BSTERGM_emp_data_run/seq3_chain3_BSTERGM_lastExNetSamplerNetworkStats.csv", header=TRUE)
