...
if table:
    ...
    for idx_pair in pair:
        ...
        reader_inst_friendship_KHEx.read_from_BERGM_csv("example_results_tailorshop_20210722/tailorshop_jointly_normPrior_edgeGWESP_20210722_"+str(fhead)+"chain_formation",
