...
if __name__ == "__main__":
    ...
    reader_inst.read_from_csv("tailorSoc_results/tailorSoc_edgeGWESPl2_model_1chain", 2, 2)

    # print(reader_inst.MC_formation_samples[0:10])
    reader_inst.MC_dissolution_samples = reader_inst.MC_dissolution_samples[10000::20]
    reader_inst.MC_formation_samples = reader_inst.MC_formation_samples[10000::20]
    ...
    netstat_reader_inst.read_from_csv("tailorSoc_results/tailorSoc_edgeGWESPl2_model_1chain_NetworkStat")
    ...
    def gof_additional_netStat(network):
        ...
        gof_netstat.append(network.statCal_geoWeightedESP(0.30103))
    ...
    #first lag
    net_plus1, net_minus1 = dissociate_network(sociational_interactions[0], sociational_interactions[1])

    gof_inst1f = BSTERGM_GOF(model_netStat, reader_inst.MC_formation_samples, sociational_interactions[0], gof_additional_netStat)
    gof_inst1f.gof_run(num_sim=200, exchange_iter=100)
    gof_inst1f.show_boxplot(next_net=net_plus1)

    gof_inst1d = BSTERGM_GOF(model_netStat, reader_inst.MC_dissolution_samples, sociational_interactions[0], gof_additional_netStat)
