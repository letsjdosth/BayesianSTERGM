...
\title{BSTERGMs: Bayesian Separable-Temporal Exponential family Random Graph Models}
\author{Seokjun Choi}
\date{December 2020}
...
and I illustrate a computational algorithm that generates posterior samples from the models dealing with the doubly-intractable constant problem. 
